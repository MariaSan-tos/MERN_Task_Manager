    ...
    if (mode === "update") {
      ...
      fetchData(config, { showSuccessToast: false }).then((data) => {
        ...
        setFormData({
          ...
          team: data.task.team.map(member => member.email) 
        });
      });
    }
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mb-4">
                ...
                <Textarea type="team" name="team" id="team" value={formData.team} placeholder="Input the colaborators email" onChange={handleChange} />
                {fieldError("team")}
              </div>
